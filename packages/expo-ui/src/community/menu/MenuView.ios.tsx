...
function renderAction(
  ...
  // SF Symbol names are strings at runtime; the strict union from sf-symbols-typescript
  // is too restrictive for the drop-in's free-form `image` field.
  const systemImage = typeof image === 'string' ? (image as SFSymbol) : undefined;
...
export function MenuView(props: MenuComponentProps) {
  const { actions, onPressAction, shouldOpenOnLongPress, title, style, children, testID } = props;
