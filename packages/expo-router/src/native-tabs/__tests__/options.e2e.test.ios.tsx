...
describe('preventSelection', () => {
  it.each([true, false] as const)(
    'forwards preventSelection=%p to Tabs.Screen as preventNativeSelection',
    (value) => {
      renderRouter({
        _layout: () => (
          <NativeTabs>
  ...
  it('does not forward preventNativeSelection when preventSelection is not set', () => {
    renderRouter({
      _layout: () => (
        <NativeTabs>
          <NativeTabs.Trigger name="index" />
  ...
  it('lets unstable_nativeProps.preventNativeSelection override preventSelection', () => {
    renderRouter({
      _layout: () => (
        <NativeTabs>
          <NativeTabs.Trigger
