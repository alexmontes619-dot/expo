...
function convertTabPropsToOptions({ hidden, children, role, disablePopToTop, disableScrollToTop, unstable_nativeProps, disableAutomaticContentInsets, contentStyle, disableTransparentOnScrollEdge, preventSelection, }, isDynamic = false) {
    const initialOptions = isDynamic
        ? {
            ...
            ...(preventSelection !== undefined ? { preventSelection } : {}),
        }
        : {
            hidden: !!hidden,
            specialEffects: {
